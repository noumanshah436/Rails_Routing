...
class Admin::StudentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_student" do
    assert_difference('Admin::Student.count') do
      post admin_students_url, params: { admin_student: { email: @admin_student.email, name: @admin_student.name } }
    end
  ...
  test "should update admin_student" do
    patch admin_student_url(@admin_student), params: { admin_student: { email: @admin_student.email, name: @admin_student.name } }
